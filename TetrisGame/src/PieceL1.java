...
public class PieceL1 extends TetrisBlock{

	public PieceL1(Point loc, Color color) {
		super(loc,color);
	...
	public TetrisBlock clone() {
		PieceL1 newPiece = new PieceL1(new Point(this.getCol(),this.getRow()), this.getColor());
		return newPiece;
	}
	
	public void updateLoc(Point loc) {
		PieceL1 updatedPiece = new PieceL1(loc, this.getColor());
