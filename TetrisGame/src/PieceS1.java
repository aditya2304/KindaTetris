...
public class PieceS1 extends TetrisBlock{

	public PieceS1(Point loc, Color color) {
		super(loc,color);
	...
	public TetrisBlock clone() {
		PieceS1 newPiece = new PieceS1(new Point(this.getCol(),this.getRow()), this.getColor());
		return newPiece;
	}
	
	public void updateLoc(Point loc) {
		PieceS1 updatedPiece = new PieceS1(loc, this.getColor());
