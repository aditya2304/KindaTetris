...
public class PieceJ1 extends TetrisBlock{

	public PieceJ1(Point loc, Color color) {
		super(loc,color);
	...
	public TetrisBlock clone() {
		PieceJ1 newPiece = new PieceJ1(new Point(this.getCol(),this.getRow()), this.getColor());
		return newPiece;
	}
	
	public void updateLoc(Point loc) {
		PieceJ1 updatedPiece = new PieceJ1(loc, this.getColor());
