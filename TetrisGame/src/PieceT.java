...
public class PieceT extends TetrisBlock{

	public PieceT(Point loc, Color color) {
		super(loc,color);
	...
	public TetrisBlock clone() {
		PieceT newPiece = new PieceT(new Point(this.getCol(),this.getRow()), this.getColor());
		return newPiece;
	}

	public void updateLoc(Point loc) {
		PieceT updatedPiece = new PieceT(loc, this.getColor());
