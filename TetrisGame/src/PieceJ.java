...
public class PieceJ extends TetrisBlock{

	public PieceJ(Point loc, Color color) {
		super(loc,color);
	...
	public TetrisBlock clone() {
		PieceJ newPiece = new PieceJ(new Point(this.getCol(),this.getRow()), this.getColor());
		return newPiece;
	}
	
	public void updateLoc(Point loc) {
		PieceJ updatedPiece = new PieceJ(loc, this.getColor());
