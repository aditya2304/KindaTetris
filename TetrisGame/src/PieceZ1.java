...
public class PieceZ1 extends TetrisBlock{

	public PieceZ1(Point loc, Color color) {
		super(loc,color);
	...
	public TetrisBlock clone() {
		PieceZ1 newPiece = new PieceZ1(new Point(this.getCol(),this.getRow()), this.getColor());
		return newPiece;
	}
	
	public void updateLoc(Point loc) {
		PieceZ1 updatedPiece = new PieceZ1(loc, this.getColor());
