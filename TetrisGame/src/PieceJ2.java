...
public class PieceJ2 extends TetrisBlock{

	public PieceJ2(Point loc, Color color) {
		super(loc,color);
	...
	public TetrisBlock clone() {
		PieceJ2 newPiece = new PieceJ2(new Point(this.getCol(),this.getRow()), this.getColor());
		return newPiece;
	}
	
	public void updateLoc(Point loc) {
		PieceJ2 updatedPiece = new PieceJ2(loc, this.getColor());
