...
public class PieceS extends TetrisBlock{

	public PieceS(Point loc, Color color) {
		super(loc,color);
	...
	public TetrisBlock clone() {
		PieceS newPiece = new PieceS(new Point(this.getCol(),this.getRow()), this.getColor());
		return newPiece;
	}
	
	public void updateLoc(Point loc) {
		PieceS updatedPiece = new PieceS(loc, this.getColor());
