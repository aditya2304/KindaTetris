...
public class PieceL extends TetrisBlock{

	public PieceL(Point loc, Color color) {
		super(loc,color);
	...
	public TetrisBlock clone() {
		PieceL newPiece = new PieceL(new Point(this.getCol(),this.getRow()), this.getColor());
		return newPiece;
	}
	
	public void updateLoc(Point loc) {
		PieceL updatedPiece = new PieceL(loc, this.getColor());
