...
public class PieceJ3 extends TetrisBlock{

	public PieceJ3(Point loc, Color color) {
		super(loc,color);
	...
	public TetrisBlock clone() {
		PieceJ3 newPiece = new PieceJ3(new Point(this.getCol(),this.getRow()), this.getColor());
		return newPiece;
	}
	
	public void updateLoc(Point loc) {
		PieceJ3 updatedPiece = new PieceJ3(loc, this.getColor());
