...
public class PieceO extends TetrisBlock{

	public PieceO(Point loc, Color color) {
		super(loc,color);
	...
	public TetrisBlock clone() {
		PieceO newPiece = new PieceO(new Point(this.getCol(),this.getRow()), this.getColor());
		return newPiece;
	}
	
	public void updateLoc(Point loc) {
		PieceO updatedPiece = new PieceO(loc, this.getColor());
