...
public class PieceL2 extends TetrisBlock{

	public PieceL2(Point loc, Color color) {
		super(loc,color);
	...
	public TetrisBlock clone() {
		PieceL2 newPiece = new PieceL2(new Point(this.getCol(),this.getRow()), this.getColor());
		return newPiece;
	}
	
	public void updateLoc(Point loc) {
		PieceL2 updatedPiece = new PieceL2(loc, this.getColor());
