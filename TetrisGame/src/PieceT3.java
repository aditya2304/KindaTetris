...
public class PieceT3 extends TetrisBlock{

	public PieceT3(Point loc, Color color) {
		super(loc,color);
	...
	public TetrisBlock clone() {
		PieceT3 newPiece = new PieceT3(new Point(this.getCol(),this.getRow()), this.getColor());
		return newPiece;
	}

	public void updateLoc(Point loc) {
		PieceT3 updatedPiece = new PieceT3(loc, this.getColor());
